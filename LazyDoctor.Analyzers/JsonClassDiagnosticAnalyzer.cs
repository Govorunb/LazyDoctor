...
public class JsonClassDiagnosticAnalyzer : DiagnosticAnalyzer
{
    ...
    {
        // filter to class declarations with [JsonClass] attribute
        var classDeclaration = (ClassDeclarationSyntax)obj.Node;
        var symbol = obj.SemanticModel.GetDeclaredSymbol(classDeclaration);
        ...
        {
            var diagnostic = Diagnostic.Create(Diagnostics.JsonSerializableMissingDescriptor, classDeclaration.Identifier.GetLocation(),
